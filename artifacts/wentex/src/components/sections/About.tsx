...
export function About() {
  return (
    <section id="about" className="py-24 md:py-32 bg-[#111111] border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            ...
            >
              <h2 className="text-xs tracking-[0.3em] uppercase text-primary mb-6">Our Heritage</h2>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative aspect-square lg:aspect-[4/5] bg-[#0A0A0A]"
            >
              <img 
              ...
              <div className="absolute -left-6 -bottom-6 lg:-left-12 lg:-bottom-12 w-32 h-32 lg:w-48 lg:h-48 bg-[#0A0A0A] p-6 lg:p-8 flex items-center justify-center border border-white/5">
                <div className="text-center">
                  <span className="block text-4xl lg:text-5xl font-serif text-white mb-2">60</span>
                  <span className="block text-[10px] tracking-widest uppercase text-primary">Years</span>
                </div>
              </div>
            </motion.div>
          </div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              ...
              />
              <h2 className="text-xs tracking-[0.3em] uppercase text-primary mb-5">Contact Us</h2>
          ...
          >
            <div className="sticky top-32 bg-white p-8 md:p-12 border border-[#0E1928]/8 shadow-sm">
              <h4 className="text-2xl font-serif text-[#0E1928] mb-6">Send an Inquiry</h4>
              <form className="space-y-6">
                {[
                  { label: "Name", type: "text" },
                  { label: "Email or Phone", type: "text" },
                ].map(({ label, type }) => (
                  <div key={label}>
                ...
                <div>
                  <label className="block text-xs uppercase tracking-widest text-[#0E1928]/45 mb-2">Message</label>
                  <textarea
                    rows={4}
              ...
              <div className="mt-8 pt-8 border-t border-[#0E1928]/8 text-center">
                <span className="block text-xs uppercase tracking-widest text-[#0E1928]/40 mb-4">Or reach out instantly</span>
                <a
